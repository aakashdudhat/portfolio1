...
import img from './img/aakashh.jpg'
                    ...
                    <div className="row">
                        <div className='sidebar col-md-12'>
                            <div className="profile">
                                ...
                                <span id='dhruv'>
                                    <h3>Aakash Dudhat</h3>
                                    <p style={{ color: '#605f5f' }} id='full'>Mern Stack Developer</p>
                                </span>
                                ...
                                <div className="sidecontact">
                                    <div id='Adress-1'>
                                        <li className='phone mt-1' id='new-li'>
                                            ...
                                            <div className="contact">
                                                ...
                                                <a href="email" >dudhataakash7@gmail.com</a>
                                            </div>
                                        </li>
                                    ...
                                    <div className="Icon-box">
                                        <ul className="social_list p-0">
                                            <li><a href="https://www.linkedin.com/in/aakash-dudhat-3265a932a"><i class="fa-brands fa-linkedin" style={{ color: "#d6d6d6" }}></i></a></li>
                                            <li><a href="https://github.com/aakashdudhat"><i class="fa-brands fa-github" style={{ color: "#d6d6d6" }}></i></a></li>
                                            <li><a href="icon"><i class="fa-brands fa-instagram" style={{ color: "#d6d6d6" }}></i></a></li>
                                            <li><a href="https://wa.me/qr/2TF4DPU66P2UJ1 "><i class="fa-brands fa-whatsapp" style={{ color: "#d6d6d6" }}></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </ol>
