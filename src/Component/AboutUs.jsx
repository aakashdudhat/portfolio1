                ...
                <div className="container" id="aboutUs">
                    <div className="row">
                        <div className="col-md-12" >
                            ...
                            <p className='web'> I'm Web Developer from Ahemdabad. Motivated and detail-oriented Computer Science graduate with a strong background in full-stack web development. Proficient in modern technologies including HTML, CSS, JavaScript, React, Node.js, and MongoDB. Completed Skill base Course  at [Ahemdabad computer center ] and  where I developed and maintained web applications, ensuring optimal performance and user experience. Proven ability to work in collaborative environments and tackle complex technical challenges through academic projects and hackathons. Eager to contribute my skills and enthusiasm to a dynamic development team in a Mern-stack developer role. </p>
